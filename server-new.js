...
PUNCTUATION RULES: Flag ONLY full stops (periods) and formal commas as errors. All other punctuation is correct. FLAG as errors: periods at sentence ends, formal commas. DO NOT flag informal language (u, ur, im, dont, cant) as errors - these are perfect for OnlyFans. DO NOT flag apostrophes, question marks, exclamation points, multiple punctuation (!!!, ???) as errors - these are perfect for OnlyFans. Examples: 'Hello, how are you.' should be 'hello how are you', 'It's nice!' should be 'It's nice!' (keep apostrophe and exclamation, remove period and comma).
  ...
  "engagementMetrics": {
    ...
    "fanRetention": "excellent"
           ...
           "grammarBreakdown": {
             ...
             "punctuationProblems": "AGGRESSIVELY FIND ALL punctuation mistakes in the messages. Look for ONLY full stops (periods) and formal commas as errors. Examples: 'Hello, how are you.' should be 'hello how are you', 'It's nice!' should be 'It's nice!' (keep apostrophe and exclamation, remove period and comma). FLAG as errors: periods at sentence ends, formal commas. DO NOT flag informal language (u, ur, im, dont, cant) as errors - these are PERFECT for OnlyFans. DO NOT flag apostrophes, question marks, exclamation points, multiple punctuation (!!!, ???) as errors - these are PERFECT for OnlyFans. BE VERY THOROUGH - scan every sentence in every message. Count and list ALL punctuation issues found with specific examples.",
