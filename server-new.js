...

{
  ...
  "engagementMetrics": {
    ...
    "fanRetention": "excellent"
           ...
           "grammarBreakdown": {
             "spellingErrors": "CRITICAL: DO NOT FLAG INFORMAL ONLYFANS LANGUAGE AS SPELLING ERRORS. 'u', 'ur', 'im', 'i', 'dont', 'ilove' are PERFECT for OnlyFans. DO NOT suggest changing 'u' to 'you', 'ur' to 'your', 'im' to 'I'm', 'i' to 'I', 'dont' to 'don't', 'ilove' to 'I love'. ONLY flag actual spelling mistakes like 'weel' instead of 'well', 'recieve' instead of 'receive', 'teh' instead of 'the'. If you find NO real spelling errors, say 'No spelling errors found'.",
             "grammarIssues": "CRITICAL: DO NOT FLAG INFORMAL ONLYFANS LANGUAGE AS GRAMMAR ERRORS. 'i go', 'u are', 'im happy', 'dont know', 'ilove you' are PERFECT for OnlyFans. DO NOT suggest changing informal to formal language. ONLY flag real grammar mistakes like 'I was went' instead of 'I went', 'he don't' instead of 'he doesn't', sentence fragments. If you find NO real grammar errors, say 'No grammar errors found'.",
  ...
  "guidelinesBreakdown": {
    ...
    "captionQuality": "STRICT messaging analysis: ANALYZE ALL messages for compliance with your custom messaging guidelines. Be STRICT - find violations. For each violation, specify WHICH guideline was violated by exact name. Count violations and successes. Provide detailed statement about messaging guideline compliance with specific examples from the messages and total count (e.g., 'Messaging guideline analysis: Found 4 violations of 'Include emojis in captions' guideline in messages like 'check this out' without emojis, 1 violation of 'Keep captions under 50 words' guideline in long messages. Found 5 messaging guideline violations total across all messages.').",
    "conversationFlow": "STRICT professionalism analysis: ANALYZE ALL messages for compliance with your custom professionalism guidelines. Be STRICT - find violations. For each violation, specify WHICH guideline was violated by exact name. Count violations and successes. Provide detailed statement about professionalism guideline compliance with specific examples from the messages and total count (e.g., 'Professionalism guideline analysis: Found 3 violations of 'Always be polite' guideline in messages like 'whatever' without politeness, 2 violations of 'Avoid slang' guideline in messages with excessive slang. Found 5 professionalism guideline violations total across all messages.').",
