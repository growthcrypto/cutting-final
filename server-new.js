...
PUNCTUATION RULES: Only flag ACTUAL punctuation mistakes. Both formal and informal punctuation are correct for OnlyFans. DO NOT flag informal language (u, ur, im, dont, cant) as errors - these are perfect for OnlyFans. DO NOT flag multiple punctuation (!!!, ???) as errors - these are perfect for OnlyFans. Only flag genuine punctuation errors like missing apostrophes in contractions when they create confusion.
...

{
  ...
  "engagementMetrics": {
    ...
    "fanRetention": "excellent"
           ...
           "grammarBreakdown": {
             ...
             "punctuationProblems": "AGGRESSIVELY FIND ALL punctuation mistakes in the messages. Look for ACTUAL punctuation errors that create confusion or are clearly wrong. Examples: missing apostrophes that create confusion, incorrect punctuation placement. DO NOT flag informal language (u, ur, im, dont, cant) as errors - these are PERFECT for OnlyFans. DO NOT flag multiple punctuation (!!!, ???) as errors - these are PERFECT for OnlyFans. Both formal and informal punctuation styles are correct for OnlyFans. Only flag genuine punctuation mistakes. BE VERY THOROUGH - scan every sentence in every message. Count and list ALL punctuation issues found with specific examples.",
  ...
  "guidelinesBreakdown": {
    ...
    "engagementQuality": "ENGAGEMENT GUIDELINE ANALYSIS: Analyze messages for engagement guideline violations. Focus on engagement-specific issues like reply time delays, lack of personal questions, missing emojis, formal language. Provide specific examples of engagement guideline violations. Format: 'Found X violations of [engagement guideline name]: [specific engagement example 1], [specific engagement example 2]. Found Y violations of [different engagement guideline name]: [different engagement example 1], [different engagement example 2].'",
    "captionQuality": "MESSAGING GUIDELINE ANALYSIS: Analyze messages for messaging guideline violations. Focus on messaging-specific issues like missing emojis in captions, unclear PPV descriptions, long captions, missing content details. Provide specific examples of messaging guideline violations. Format: 'Found X violations of [messaging guideline name]: [specific messaging example 1], [specific messaging example 2]. Found Y violations of [different messaging guideline name]: [different messaging example 1], [different messaging example 2].'",
    "conversationFlow": "PROFESSIONALISM GUIDELINE ANALYSIS: Analyze messages for professionalism guideline violations. Focus on professionalism-specific issues like being too formal, lack of politeness, abrupt topic changes, missing personalization. Provide specific examples of professionalism guideline violations. Format: 'Found X violations of [professionalism guideline name]: [specific professionalism example 1], [specific professionalism example 2]. Found Y violations of [different professionalism guideline name]: [different professionalism example 1], [different professionalism example 2].'",
...
- Both formal and informal punctuation styles are correct for OnlyFans
