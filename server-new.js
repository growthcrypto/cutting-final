...
- INFORMAL LANGUAGE: Informal language is GOOD (u, ur, gonna, etc.). Formal language is BAD and should be avoided.
...

{
  ...
  "grammarBreakdown": {
    ...
    "informalLanguage": "COMPREHENSIVE formal language analysis: Count ALL inappropriate formal language found across ALL messages. ONLYFANS CHATTING RULES: Informal language is GOOD (u, ur, gonna, etc.). Formal language is BAD and should be avoided. Provide detailed statement about inappropriate formal language with specific examples and total count (e.g., 'Main formal language issues: frequent use of formal words like 'you' instead of 'u', 'your' instead of 'ur', 'going to' instead of 'gonna', and overly formal sentence structures. Found 25 inappropriate formal language uses total across all messages.').",
          ...
          try {
            ...
            const reAnalysis = {
              grammarBreakdown: {
                ...
                informalLanguage: `Main formal language issues: frequent use of formal words like 'you' instead of 'u', 'your' instead of 'ur', 'going to' instead of 'gonna', and overly formal sentence structures. ONLYFANS RULE: Informal language is GOOD. Found ${combinedInformalPatterns} inappropriate formal language uses total across all ${analysisMessageTexts.length} messages.`,
                scoreExplanation: `Comprehensive analysis of all ${analysisMessageTexts.length} messages: Focus on improving spelling accuracy, grammar consistency, using ONLY ! and ? punctuation, and maintaining informal OnlyFans chatting style.`
              }
            };
