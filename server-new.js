...
CRITICAL: Do NOT just list these guidelines. Instead, ANALYZE the messages for compliance with these guidelines. For each violation, specify WHICH specific guideline was violated by name. Count violations and successes. Provide specific examples from the messages where guidelines are followed or violated.
...

{
  ...
  "guidelinesBreakdown": {
    "salesEffectiveness": "COMPREHENSIVE sales analysis: ANALYZE the messages for compliance with your custom sales guidelines. For each violation, specify WHICH guideline was violated. Count violations and successes. Provide detailed statement about sales guideline compliance with specific examples from the messages and total count (e.g., 'Sales guideline analysis: Found 8 violations of 'Always ask for tips' guideline in messages like 'how are you' without asking for tips, 3 violations of 'Use urgency in PPV captions' guideline in messages like 'check this out' without urgency. Found 12 sales guideline violations total across all messages.').",
    "engagementQuality": "COMPREHENSIVE engagement analysis: ANALYZE the messages for compliance with your custom engagement guidelines. For each violation, specify WHICH guideline was violated. Count violations and successes. Provide detailed statement about engagement guideline compliance with specific examples from the messages and total count (e.g., 'Engagement guideline analysis: Found 5 violations of 'Always respond within 5 minutes' guideline in delayed responses, 2 violations of 'Ask personal questions' guideline in messages like 'how are you' without follow-up questions. Found 7 engagement guideline violations total across all messages.').",
    "captionQuality": "COMPREHENSIVE messaging analysis: ANALYZE the messages for compliance with your custom messaging guidelines. For each violation, specify WHICH guideline was violated. Count violations and successes. Provide detailed statement about messaging guideline compliance with specific examples from the messages and total count (e.g., 'Messaging guideline analysis: Found 4 violations of 'Include emojis in captions' guideline in messages like 'check this out' without emojis, 1 violation of 'Keep captions under 50 words' guideline in long messages. Found 5 messaging guideline violations total across all messages.').",
    "conversationFlow": "COMPREHENSIVE professionalism analysis: ANALYZE the messages for compliance with your custom professionalism guidelines. For each violation, specify WHICH guideline was violated. Count violations and successes. Provide detailed statement about professionalism guideline compliance with specific examples from the messages and total count (e.g., 'Professionalism guideline analysis: Found 3 violations of 'Always be polite' guideline in messages like 'whatever' without politeness, 2 violations of 'Avoid slang' guideline in messages with excessive slang. Found 5 professionalism guideline violations total across all messages.').",
