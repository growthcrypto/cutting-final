...

{
  ...
  "guidelinesBreakdown": {
    "salesEffectiveness": "STRICT sales analysis: ANALYZE ALL messages for compliance with your custom sales guidelines. Be STRICT - find violations. For each violation, specify WHICH guideline was violated by exact name AND provide DIFFERENT specific examples for each violation. Count violations and successes. Format: 'Found X violations of [guideline name] guideline: [specific example 1], [specific example 2], [specific example 3]. Found Y violations of [different guideline name] guideline: [different specific example 1], [different specific example 2].'",
